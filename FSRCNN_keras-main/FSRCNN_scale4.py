...
def model():
    ...
    FSRCNN.add(Conv2DTranspose(filters = 1, kernel_size = (9,9), strides = (4,4), bias_initializer = 'zeros',
    ...
    FSRCNN.compile(optimizer = LRMultiplier(Adam(lr=0.001), {'layer_1':1, 'layer_2':1, 'layer_3':1, 'layer_4':1,
...
def train():
    ...
    #fsrcnn_model.load_weights('checkpoint/FSRCNN_checkpoint_4', by_name = True)
    fsrcnn_model.load_weights('checkpoint/FSRCNN_checkpoint_4_General100.h5')
    
    print(fsrcnn_model.summary())
    
    '''
    data, label = ps.read_training_data('training_sample/train_General100aug_4.h5')
    val_data, val_label = ps.read_training_data('training_sample/cross_val_200_4.h5')
    '''
    ...
    checkpoint_filepath = 'checkpoint/FSRCNN_checkpoint_4_General100.h5'
    ...
    for i in range(0,1):
        ...
        fsrcnn_model.save('model_weight/FSRCNN_check_4_91aug_General100.h5')
        '''
        count += 1
