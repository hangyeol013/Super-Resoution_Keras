...
def model():
    ...
    FSRCNN.add(Conv2DTranspose(filters = 1, kernel_size = (9,9), strides = (3,3), bias_initializer = 'zeros',
...
def train():
    ...
    fsrcnn_model.load_weights('checkpoint/FSRCNN_checkpoint_3_General100.h5')
    
    
    print(fsrcnn_model.summary())
    '''
    data, label = ps.read_training_data('training_sample/train_91aug_3.h5')
    val_data, val_label = ps.read_training_data('training_sample/cross_val_200_3.h5')
    '''
    ...
    checkpoint_filepath = 'checkpoint/FSRCNN_checkpoint_3_General100.h5'
    ...
    for i in range(0,1):
        ...
        fsrcnn_model.save('model_weight/FSRCNN_check_3_91aug_General100.h5')
        '''
