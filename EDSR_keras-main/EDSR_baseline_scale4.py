...
def train():
    ...
    edsr_model.load_weights('checkpoint/EDSR_checkpoint_baseline_scale4.h5')
    #edsr_model.load_weights('checkpoint/EDSR_checkpoint_baseline_scale2_pre_2.h5', by_name = True)
    '''
    data, label = ps.read_training_data('training_sample/train_DIV2Kaug_scale4_2.h5')
    ...
    checkpoint_filepath = 'checkpoint/EDSR_checkpoint_baseline_scale4.h5'
    ...
    for i in range(0, 1):
        ...
        edsr_model.save('model_weight/EDSR_baseline_scale4.h5')
        '''
