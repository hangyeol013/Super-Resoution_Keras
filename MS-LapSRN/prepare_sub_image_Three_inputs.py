...
def read_training_data(file):
    with h5py.File(file, 'r') as hf:
        ...
        label_x2 = np.array(hf.get('label_x2'))
        label_x4 = np.array(hf.get('label_x4'))
        train_data = np.transpose(data, (0, 2, 3, 1))
        train_label_x2 = np.transpose(label_x2, (0, 2, 3, 1))
        train_label_x4 = np.transpose(label_x4, (0, 2, 3, 1))
        
        return train_data, train_label_x2, train_label_x4
