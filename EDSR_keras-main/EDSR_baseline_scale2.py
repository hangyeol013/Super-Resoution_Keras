...
def train():
    ...
    edsr_model.load_weights('checkpoint/EDSR_checkpoint_baseline_scale2.h5')
    
    '''
    data, label = ps.read_training_data('training_sample/train_DIV2Kaug_scale2_3.h5')
    ...
    #PATH_image = '/media/idea/ideaHome/mm/HG/SR/Dataset/test/test_mat/{}/scale{}/'.format(test_set, scale)
    ...
    checkpoint_filepath = 'checkpoint/EDSR_checkpoint_baseline_scale2_pre_3.h5'
    ...
    for i in range(0, 1):
        ...
        edsr_model.save('model_weight/EDSR_baseline_scale2_pre_3.h5')
        '''
